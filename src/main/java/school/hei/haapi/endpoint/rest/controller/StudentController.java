...
public class StudentController {
  ...
  public List<Student> getStudents(
          ...
          @RequestParam(value = "group", required = false, defaultValue = "") String groupRef) {
    return userService.getByCriteria(User.Role.STUDENT, firstName, lastName, ref, groupRef, page, pageSize
            ).stream()
