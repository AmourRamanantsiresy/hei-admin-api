...
public class PlaceIT {
    ...
    public static Place place2() {
        ...
        place.setLabel("place2");
        return place;
    }

    public static Place someCreatablePlace() {
        Place place = new Place();
        place.setLabel("PLACE22-" + randomUUID());
        return place;
    }
    ...
    void manager_write_create_ok() throws ApiException {
        ...
        assertNotNull(created3.getLabel());
        toCreate3.setLabel(created3.getLabel());
        //
        ...
        assertNotNull(created4.getLabel());
        toCreate4.setLabel(created4.getLabel());
